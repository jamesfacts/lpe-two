<div class="events-form-mailpoet mailpoet_form mailpoet_form_widget mailpoet_form_position_ mailpoet_form_animation_ newsletter-contain xl:pl-1" id="mailpoet_form_3" >
    ...
    <form target="_self" method="post" action="https://lpeproject.org/wp-admin/admin-post.php?action=mailpoet_subscription_form" class="mailpoet_form mailpoet_form_form mailpoet_form_widget" novalidate="" data-delay="" data-exit-intent-enabled="" data-font-family="" style="padding: 0;">
        <input type="hidden" name="data[form_id]" value="3">
        <input type="hidden" name="token" value="1b36e7b4ea">
