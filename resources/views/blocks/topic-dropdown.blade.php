@if($block->preview)
    <h3 style="font-family: Rubik, sans-serif; margin-top:2rem;">Blog Topic Dropdown</h3>
    <select name="" id="">
        <option value="">Blog topics will appear here...</option>
    </select>
@else
<div class="mt-3">
@if($topics)
<span class="uppercase block mb-1">Sort By Topics</span>
