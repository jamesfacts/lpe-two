...
@section('content')
  @while(have_posts()) @php(the_post())
    <section class="engage-header px-6 py-12 sm:px-8 lg:px-16 xl:px-24">
    ...
    <section class="px-6 py-12 sm:px-8 lg:px-16 xl:px-24">
      ...
      <div class="max-w-1400">
        <aside class="">
        <h1 class="text-5xl font-bold uppercase leading-none 
                            font-rubik tracking-tighter mb-10 lg:leading-6 lg:mb-16">Student<br/>Groups</h1>
        </aside>
    ...
    <section class="px-6 py-12 sm:px-8 lg:px-16 xl:px-24">
      <div class="max-w-1400 xl:flex">
        <aside class="max-w-sm xl:w-1/4">
          <h1 class="text-5xl font-bold uppercase leading-none 
                            font-rubik tracking-tighter mb-10 lg:leading-6 lg:mb-16">Start a Student<br/>Group</h1>
        </aside>
        <div class="mb-8 max-w-5xl xl:w-3/4 xl:pl-12">
    ...
    <section class="bg-tahini-500 px-6 py-12 sm:px-8 lg:px-16 xl:px-24">
      <div class="max-w-1400 xl:flex">
        ...
        <h1 class="text-5xl font-bold uppercase leading-none 
                            font-rubik tracking-tighter mb-4 lg:leading-6 lg:mb-6">Speakers<br/>Bureau</h1>
          <div class="mb-8">
